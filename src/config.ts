...
export const OCR_BOXES: Record<SectionId, OcrBox[]> = {
  ...
  sport: [
    ...
    { pointBox: [0.595, 0.319, 0.170, 0.050] },
    { pointBox: [0.770, 0.320, 0.170, 0.050] },
    // Row 2
    { pointBox: [0.420, 0.547, 0.170, 0.050] },
    { pointBox: [0.595, 0.548, 0.170, 0.050] },
    { pointBox: [0.770, 0.547, 0.170, 0.050] },
    // Row 3
    { pointBox: [0.420, 0.775, 0.170, 0.050] },
  ],
  standard: [
    // Row 1
    { pointBox: [0.420, 0.388, 0.170, 0.050] },
    { pointBox: [0.595, 0.390, 0.170, 0.050] },
    { pointBox: [0.770, 0.386, 0.170, 0.050] },
    // Row 2
    { pointBox: [0.420, 0.616, 0.170, 0.050] },
    { pointBox: [0.595, 0.617, 0.170, 0.050] },
    { pointBox: [0.770, 0.617, 0.170, 0.050] },
    // Row 3
    { pointBox: [0.420, 0.844, 0.170, 0.050] },
  ],
}
